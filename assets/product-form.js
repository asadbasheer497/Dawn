        ...
        fetch(`${routes.cart_add_url}`, config)
          ...
          .then((response) => {
            ...
            if (quickAddModal) {
              ...
              console.log("response: "+response.outerHTML);
              this.cart.renderContents(response);
            }
          })
          .catch((e) => {
...
function bundleProductAdd(params) {
    var variantIds = params.split(',');
    var data = {
    ...
    .then(data => {
        ...
        if (data.message) {} else {
           var cart__drawer = document.getElementById("CartDrawer");
            fetch(window.location.href)
              ...
              .then(data => {
                ...
                cart__drawer.innerHTML = updatedContent;
              })
              .catch(error => {
